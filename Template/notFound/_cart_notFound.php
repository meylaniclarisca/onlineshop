...
<section id="cart" class="py-3 mb-5">
    <div class="container-fluid w-75">
        <h5 class="font-baloo font-size-20">Alfamart</h5>
                ...
                <!-- Empty Cart -->
                    <div class="row border-top py-3 mt-3">
                        <div class="col-sm-12 text-center py-2">
                            ...
                            <p class="font-baloo font-size-16 text-black-50">Alfamart</p>
                        </div>
                    </div>
                <!-- .Empty Cart -->
            </div>
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        ...
                        <button type="submit" class="btn btn-warning mt-3">Proses Bayar </button>
                    </div>
                </div>
            </div>
            <!-- !subtotal section-->
